...
{
	[DataContract(Name = "ServiceStatus", Namespace = "http://backgroundworkerservice/DataModel/01/01/12")]
	public class ServiceStatus
	{
		internal ServiceStatus(ServiceHost host)
		{
			var query = from q in ((AccessPoint)host.SingletonInstance).serviceInstance.WorkerService.JobQueues
