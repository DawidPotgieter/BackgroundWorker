...
{
	[DataContract(Name = "JobData", Namespace = "http://backgroundworkerservice/DataModel/01/04/12")]
	public class JobData
	{
		internal JobData(Logic.DataModel.Jobs.JobData jobData)
		{
			...
			this.Id = jobData.Id;
			this.UniqueId = jobData.UniqueId;
			...
			this.NextStartTime = jobData.NextStartTime;
		...
		[DataMember(Name = "NextStartTime", IsRequired = true)]
