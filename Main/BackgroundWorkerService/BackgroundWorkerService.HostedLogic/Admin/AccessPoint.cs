...
namespace BackgroundWorkerService.Service.Admin
{
	...
	public class AccessPoint : IAccessPoint
	{
		...
		internal BackgroundWorkerService.Logic.Service workerService;
		private ISettingsProvider settingsProvider;

		public AccessPoint(BackgroundWorkerService.Logic.Service workerService, ISettingsProvider settingsProvider)
		{
			jobManager = workerService.JobManager;
			this.workerService = workerService;
			this.workerService.Notify += new EventHandler<NotificationEventArgs>(WorkerService_Notify);
