	...
	public class RamJobStore : IJobStore
	{
		...
		public RamJobStore(ISettingsProvider settingsProvider, ILog logger)
		{
			lock (this)
			{
				...
				{
					var jobStoreSettingsProvider = Helpers.Utils.CreateInstanceWithRequiredInterface(settings.JobStoreSettingsProviderType.AssemblyQualifiedName, "IRamJobStoreSettingsProvider") as IRamJobStoreSettingsProvider;
