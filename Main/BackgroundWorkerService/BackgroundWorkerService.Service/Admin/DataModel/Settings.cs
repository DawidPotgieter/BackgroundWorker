...
{
	[DataContract(Name = "Settings", Namespace = "http://backgroundworkerservice/DataModel/01/04/12")]
	public class Settings
	{
		internal Settings(BackgroundWorkerService.Logic.Interfaces.ISettingsProvider settingsProvider)
		{
			...
			JobStoreType = settingsProvider.JobStoreType.AssemblyQualifiedName;
			JobStoreSettingsProviderType = settingsProvider.JobStoreSettingsProviderType.AssemblyQualifiedName;
