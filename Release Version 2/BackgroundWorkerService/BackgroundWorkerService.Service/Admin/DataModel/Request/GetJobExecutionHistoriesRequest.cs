...
{
	[DataContract(Name = "GetJobExecutionHistoriesRequest", Namespace = "http://backgroundworkerservice/DataModel/01/04/12")]
	public class GetJobExecutionHistoriesRequest
	{
		...
		[DataMember(Name = "Ids", IsRequired = false)]
		public List<long> Ids { get; set; }

		[DataMember(Name = "JobUniqueIds", IsRequired = false)]
		public List<Guid> JobUniqueIds { get; set; }
