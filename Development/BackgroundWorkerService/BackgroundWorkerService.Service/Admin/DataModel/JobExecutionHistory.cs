...
{
	[DataContract(Name = "JobExecutionHistory", Namespace = "http://backgroundworkerservice/DataModel/01/04/12")]
	public class JobExecutionHistory
	{
		internal JobExecutionHistory(Logic.DataModel.Jobs.JobExecutionHistory jobExecutionHistory)
		{
			...
			this.JobUniqueId = jobExecutionHistory.JobUniqueId;
		...
		[DataMember(Name = "JobUniqueId", IsRequired = true)]
