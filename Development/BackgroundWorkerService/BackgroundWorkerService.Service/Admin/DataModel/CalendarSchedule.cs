...
{
	[DataContract(Name = "CalendarSchedule", Namespace = "http://backgroundworkerservice/DataModel/01/04/12")]
	public class CalendarSchedule : Schedule
	{
		internal CalendarSchedule()
			: base()
		{
		...
		internal new Logic.DataModel.Scheduling.ISchedule AsInternalSchedule()
		{
			...
			Logic.DataModel.Scheduling.CalendarSchedule schedule = Logic.Helpers.Utils.CreateInstanceWithRequiredInterface<Logic.DataModel.Scheduling.CalendarSchedule>(this.ScheduleType, typeof(Logic.DataModel.Scheduling.ISchedule).AssemblyQualifiedName);
			schedule
