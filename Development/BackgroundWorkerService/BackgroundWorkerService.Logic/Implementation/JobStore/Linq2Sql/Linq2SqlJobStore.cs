...
namespace BackgroundWorkerService.Logic.Implementation.JobStore.Linq2Sql
{
	...
	public class Linq2SqlJobStore : IJobStore
	{
		...
		public Linq2SqlJobStore()
			: this(ConfigurationSettings.SettingsProvider, LogManager.GetCurrentClassLogger(), Utils.CreateInstanceWithRequiredInterface<ILinq2SqlJobStoreSettingsProvider>(ConfigurationSettings.SettingsProvider.JobStoreSettingsProviderType.AssemblyQualifiedName, typeof(ILinq2SqlJobStoreSettingsProvider).AssemblyQualifiedName))
		{
		}
